...
/* This module is a low-level debugger for Inform 6 (and 7) games.
   ...
   When debugging is compiled in, glulxe offers a bunch of new command-line
   options:
   
   --gameinfo filename: Read the "gameinfo.dbg" file generated by the I6
     compiler. (Must be the new XML-based debug format.)
   --gameinfodata num: Look for "gameinfo.dbg" in a DATA chunk of the
     Blorb file, rather than a separate file.
